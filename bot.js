...
.then(channel =>
 ...
 message.guild.createChannel(`🎮》DIGER`, 'voice')
 .then(channel =>
  channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|OYUN ODALARI|▬▬|")))
...
client.on(`guildMemberAdd`, async member => {
  ...
  .addField(`Sunucumuza geldiğin için teşekkür ederim!`, `RONESANS iyi eğlenceler diler`)
    .addField(`Davet Linkleri;`, `[Botu Sunucuna Eklemek için Tıkla](https://discordapp.com/oauth2/authorize?client_id=581090432092733450&scope=bot&permissions=2146958591)\n[Botun Destek Sunucusu](https://discord.gg/ge3bD5y)`)
    .setFooter(`Bu Sunucu 7/24 RONESANS tarafından korunuyor.`)
  member.send(e);
});
...
client.on(`guildMemberRemove`, async member => {
  const a = new Discord.RichEmbed()
    ...
    .addField(`Sunucumuzdan Gittiğin İçin 

Üzüldük!`, `RONESANS Çok Üzüldü`)
