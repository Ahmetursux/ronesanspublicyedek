...
exports.run = async (client,message,args) => {
  ...
  .setColor("#36393F")
  .setDescription("❌ Lütfen Bir Rol İsmi Yazın `Örnek: r!rolbilgi Üye` **Not: Kendinizden Yüksek Rollere Bakamassınız Ayrıca Rolü Etiketlemeyin Sadece İsmini Yazın** ");
